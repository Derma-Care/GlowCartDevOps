...
public class ProcedurePricingMapper {
	...
	public ProcedurePricing toEntity(ProcedurePricingDTO dto) {
		...
		entity.setPostProcedureQA(
				dto.getPostProcedureQA() != null ? sanitizeQAList(dto.getPostProcedureQA()) : List.of());
	...
	public ProcedurePricingDTO toDto(ProcedurePricing entity) {
		...
		dto.setPreProcedureQA(
				entity.getPreProcedureQA() != null ? restoreQAList(entity.getPreProcedureQA()) : List.of());
		dto.setProcedureQA(entity.getProcedureQA() != null ? restoreQAList(entity.getProcedureQA()) : List.of());
		dto.setPostProcedureQA(
				entity.getPostProcedureQA() != null ? restoreQAList(entity.getPostProcedureQA()) : List.of());
