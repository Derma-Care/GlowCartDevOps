...
public class ProcedurePricingMapper {
	...
	public ProcedurePricing toEntity(ProcedurePricingDTO dto) {
	    ...
	    entity.setPreProcedureQA(dto.getPreProcedureQA());
	    entity.setProcedureQA(dto.getProcedureQA());
	    entity.setPostProcedureQA(dto.getPostProcedureQA());
	    entity.setSittings(dto.getSittings()); // NEW
	...
	public ProcedurePricingDTO toDto(ProcedurePricing entity) {
	    ...
	    dto.setPreProcedureQA(entity.getPreProcedureQA());
	    dto.setProcedureQA(entity.getProcedureQA());
	    dto.setPostProcedureQA(entity.getPostProcedureQA());
	    dto.setSittings(entity.getSittings()); // NEW
